...
set_driving_cell  -lib_cell DFFX1  -pin Q -library $library_name [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
}

if {$tech_lib == $tsmc065_tech_lib} {
set_driving_cell  -lib_cell DFQD1  -pin Q -library $library_name [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
}


if {$tech_lib == $saed90nm_tech_lib} {
set_driving_cell  -lib_cell DFFARX1  -pin Q -library $library_name [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
}

if {$tech_lib == $saed32nm_tech_lib} {
set_driving_cell  -lib_cell DFFARX1_RVT  -pin Q -library $library_name [list [remove_from_collection [all_inputs] [list clk reset scan_en]]]
}
