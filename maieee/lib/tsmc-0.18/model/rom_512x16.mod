 ...
 *      Pipeline:       No
 *
 *      Creation Date:  2002-01-13 20:31:43Z
 *      Version:        2000Q3V0
 *
...
tch_tas: SETUP(POSEDGE) A CLK ;
tch_tah: HOLD(POSEDGE) A CLK ;
tch_tcs: SETUP(POSEDGE) CEN CLK ;
tch_tch: HOLD(POSEDGE) CEN CLK ;
dly_tansp: DELAY(POSEDGE) CLK Q  ;
ENDMODEL
